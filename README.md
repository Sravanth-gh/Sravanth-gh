...
class SravanthKumar:
    def __init__(self):
        self.name       = "Sravanth Kumar Mahasivabhattu"
        self.role       = "Full Stack Developer & AI Enthusiast"
        self.education  = "B.Tech CSE (Lateral Entry) @ Raghu Engineering College"
        self.location   = "Visakhapatnam, India 🇮🇳"
        self.email      = "sravanthkumar8989@gmail.com"
        self.status     = "🔍 Actively Job Hunting"
    ...
    def skills(self):
        return {
            ...
            "ai_stack"   : ["Groq API", "LLaMA 3.1", "LangChain", "Vector DBs", "LLM Agents"],
        }

    def current_focus(self):
        return "Building AI-powered full stack applications 🤖"

    def fun_fact(self):
        return "Secured 🥈 2nd Place at 'Data Paradox' with Team Titans 🏆"
...
⚙️ Backend	FastAPI, Python, Pydantic, Uvicorn
🗄️ Database	MongoDB Atlas, PyMongo
🔐 Auth	JWT, PyJWT, bcrypt, HTTP Bearer
🤖 AI	Groq API, LLaMA 3.1 8B Instant, Prompt Engineering
...
🥈	2nd Place — Data Paradox (Team Titans)	Raghu Engineering College	2025
🎓	NPTEL Elite — Programming in Java (60%)	IIT Kharagpur / SWAYAM	2025
🎓	NPTEL — Database Management System (57%)	IIT Kharagpur / SWAYAM	2025
🏢	Fullstack Python — Industrial Internship (6 months)	Anurag IT Solutions	2025
💼	Web Development Intern	SkillCraft Technology	Jun–Jul 2025
🌐	AICTE Virtual Intern — Google Cloud Generative AI	EduSkills / Google Cloud	Apr–Jun 2026
...
🔭 Diving deep into:
   ...
   ├── 🤖 LLM Agents — autonomous AI systems & tool use
...
Full Stack Developer	Web & AI Contributions	LLM / RAG Applications	Early-stage products
Python Developer	Bug fixes & Features	AI Agents & Automation	MVP Development
...
>
> I'm a CS student from Visakhapatnam who loves turning ideas into intelligent, real-world applications.
...
---
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=6C63FF&height=100&section=footer&text=&fontSize=0" width="100%"/>
</div>
